...
parser = argparse.ArgumentParser(description='RecVis A3 annotation script')
...
parser.add_argument('--out', type=str, default='bird_dataset', metavar='D',
                    help="folder to store the new annotated data")
parser.add_argument('--out-no', type=str, default='pseudo_no', metavar='D',
                    help="folder to store the non annotated images")
